...
public class MimeTypes {
  ...
  public static void main(String[] args) {
    System.out.println(mimeTypeMapping.size());
      System.out.println(MimeTypes.getExtension("text/html"));
  }
  ...
  public static String getExtension(String mimeTipe){
      String ext = ".txt";
      
      Iterator it = mimeTypeMapping.keySet().iterator();
      if(mimeTipe!=null){
      while(it.hasNext()){
          String k = (String) it.next();
          String mime = mimeTypeMapping.get(k);
          
          if(mimeTipe.contains(mime)){
              ext =  k;
              break;
            }
      }
